...
namespace LargeJsonApi.Model.Seasons
{
    ...
    public class FulfillmentData
    {
        ...
        public object DeviceConstraints { get; set; }
    }

    public class LicensingKey
    {
        public string LicensingKeyId { get; set; }
    ...
    public class Package
    {
        ...
        public List<LicensingKey> LicensingKeys { get; set; }
        public string PolicyCardId { get; set; }
    ...
    {
        public int LicenseSkuRank { get; set; }
        ...
        public List<object> RemediationProducts { get; set; }
        public bool IsLicensingGeofenced { get; set; }
    }
    ...
    public class VideoInstance
    {
        ...
        public string CDNFileLocationURI { get; set; }
        ...
        public List<OverlayFile> OverlayFiles { get; set; }
    ...
    public class Properties2
    {
        ...
        public List<VideoInstance> VideoInstances { get; set; }
    ...
    public class Contributor
    {
        ...
        public List<object> AlternateContributorIds { get; set; }
    }
