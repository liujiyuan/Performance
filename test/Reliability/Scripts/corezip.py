...
def pack(strCorePath, strFilePath, strZipPath):
    import lldb
    ...
    result = run_command("target create --no-dependents --arch x86_64 --core " + strCorePath + " " + strFilePath, interpreter)
